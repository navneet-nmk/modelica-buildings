...
block FMUZoneAdapter "Block that interacts with this EnergyPlus zone"
  ...
  parameter Integer[nVarSen] valRefVarSen "Value references of variables sent to EnergyPlus";
  ...
  parameter Integer[nVarRec] valRefVarRec "Value references of variables received from EnergyPlus";
...
protected
  Buildings.ThermalZones.EnergyPlus.BaseClasses.FMUZoneClass adapter=
      ...
      nVarRec=nVarRec,
      varNamRec=varNamRec,
      valRefVarRec=valRefVarRec) "Class to communicate with EnergyPlus";
